                ...
                <div class="card-body">
                    @if (session('status'))
                        <div class="alert alert-success" role="alert">
                            Voucher {{ session('kode') }} telah dihapus. Ingin dibatalkan??
                            
                            <a href="{{ route('voucher.restore', ['voucher'=> session('kode')]) }}">Restore</a>
                            ...
                            @foreach ($voucher as $voc)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('voucher.edit', ['voucher'=> $voc->id]) }}">Ubah</a> | <a  href="#"
                                        onclick="event.preventDefault();document.getElementById('delete-{{ $voc->id }}').submit();">Hapus</a>
                                    
                                        <form id="delete-{{ $voc->id }}" action="{{ route('voucher.destroy', $voc->id) }}" method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE');
                                        </form>
